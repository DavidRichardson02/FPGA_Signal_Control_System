...
/*==============================================================================
  ...
  Design goal for now:
    ...
    - Later can replace the internal "fake temperature" logic with a
...
module tmp_temp_reader #(
    ...
    // XADC-based path. A good choice is somewhere between occupied and
    ...
    // so that if switch temp_src_sel to TEMP_SRC_TMP, the fan controller
    // will see a sensible "room temperature".
    //==========================================================================

    localparam signed [15:0] TEMP_ROOM_Q15 = 16'sd14564;  // ≈72°F in scale
